...
/* harmony import */ var _delete_account_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./delete-account.page */ "./src/app/pages/delete-account/delete-account.page.ts");
...
DeleteAccountPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var _delete_account_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./delete-account-routing.module */ "./src/app/pages/delete-account/delete-account-routing.module.ts");
/* harmony import */ var _delete_account_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./delete-account.page */ "./src/app/pages/delete-account/delete-account.page.ts");
...
DeleteAccountPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _delete_account_routing_module__WEBPACK_IMPORTED_MODULE_5__["DeleteAccountPageRoutingModule"]
        ],
...
let DeleteAccountPage = class DeleteAccountPage {
    constructor(router, afdb, dataService, loading, statusService) {
        this.router = router;
        this.afdb = afdb;
    ...
    delete() {
        this.loading.show();
        this.afdb.object('/account' + firebase__WEBPACK_IMPORTED_MODULE_7__["auth"]().currentUser.uid).query.orderByChild('phoneNumber').equalTo(this.phoneNumber).once('value', snap => {
            this.afdb.database.ref('/account').child(firebase__WEBPACK_IMPORTED_MODULE_7__["auth"]().currentUser.uid).remove().then(() => {
                firebase__WEBPACK_IMPORTED_MODULE_7__["auth"]().signOut().then((success) => {
                    this.loading.hide();
...
DeleteAccountPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_6__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./delete-account.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/delete-account/delete-account.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./delete-account.page.scss */ "./src/app/pages/delete-account/delete-account.page.scss")).default]
    })
], DeleteAccountPage);
...
//# sourceMappingURL=pages-delete-account-delete-account-module-es2015.js.map