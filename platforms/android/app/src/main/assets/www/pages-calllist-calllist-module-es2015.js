...
/* harmony import */ var _calllist_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./calllist.page */ "./src/app/pages/calllist/calllist.page.ts");
...
/* harmony import */ var _calllist_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./calllist-routing.module */ "./src/app/pages/calllist/calllist-routing.module.ts");
/* harmony import */ var _calllist_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./calllist.page */ "./src/app/pages/calllist/calllist.page.ts");
...
let CalllistPage = class CalllistPage {
    ...
    ngOnInit() {
        ...
        this.dataService.getUsers().valueChanges().subscribe((accounts) => {
            ...
            this.dataService.getCurrentUser(firebase__WEBPACK_IMPORTED_MODULE_8__["auth"]().currentUser.uid).valueChanges().subscribe((account) => {
    ...
    call(item) {
        this.callNumber.callNumber(`${item.phoneNumber}`, true).then(() => {
            ...
            this.afDB.list('/accounts/' + firebase__WEBPACK_IMPORTED_MODULE_8__["auth"]().currentUser.uid + '/call/').push({
...
CalllistPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./calllist.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/calllist/calllist.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./calllist.page.scss */ "./src/app/pages/calllist/calllist.page.scss")).default]
    })
], CalllistPage);
...
//# sourceMappingURL=pages-calllist-calllist-module-es2015.js.map