(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-newgroup-newgroup-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppPagesNewgroupNewgroupPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesNewgroupNewgroupRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "NewgroupPageRoutingModule", function () {
        return NewgroupPageRoutingModule;
      });
      /* harmony import */
      ...
      var _newgroup_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./newgroup.page */
      ...
      var NewgroupPageRoutingModule = function NewgroupPageRoutingModule() {
        _classCallCheck(this, NewgroupPageRoutingModule);
      };

      NewgroupPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppPagesNewgroupNewgroupModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _newgroup_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./newgroup-routing.module */
      "./src/app/pages/newgroup/newgroup-routing.module.ts");
      /* harmony import */
      ...
      NewgroupPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _newgroup_routing_module__WEBPACK_IMPORTED_MODULE_5__["NewgroupPageRoutingModule"]],
    ...
    /***/
    function srcAppPagesNewgroupNewgroupPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesNewgroupNewgroupPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      */
      ...
      var NewgroupPage = /*#__PURE__*/function () {
        function NewgroupPage(toastController, dataService, formBuilder, camera, imageService, loading, angularDb, router, actionSheetController, navCtrl) {
          ...
          this.formGroup = this.formBuilder.group({
            name: new _angular_forms__WEBPACK_IMPORTED_MODULE_10__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_10__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_10__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_10__["Validators"].minLength(5), _angular_forms__WEBPACK_IMPORTED_MODULE_10__["Validators"].maxLength(30)]))
          });
        }
        ...
        _createClass(NewgroupPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.dataService.getUsers().valueChanges().subscribe(function (accounts) {
              ...
              _this.dataService.getCurrentUser(firebase__WEBPACK_IMPORTED_MODULE_5__["auth"]().currentUser.uid).valueChanges().subscribe(function (account) {
                _this.groupMembers = [account];
                _this.createName = account.nikeName; //add own userId as excludedIds.
          ...
          key: "setImageCamera",
          value: function setImageCamera() {
            var _this2 = this;

            return new Promise(function (resolve) {
              _this2.camera.getPicture(_this2.groupPhotoOptionCamera).then(function (url) {
                _this2.group = "data:image/jpeg;base64," + url;
                resolve(true);
              });
            });
          }
          ...
          key: "setImageGallery",
          value: function setImageGallery() {
            var _this3 = this;

            return new Promise(function (resolve) {
              _this3.camera.getPicture(_this3.groupPhotoOptionGallery).then(function (url) {
                _this3.group = "data:image/jpeg;base64," + url;
                resolve(true);
              });
            });
                      ...
                      return this.actionSheetController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            _this4.imageService.setGroupPhoto(_this4.group, _this4.camera.PictureSourceType.CAMERA);
                          }
                        }, {
                          text: 'Gallery',
                          icon: 'images',
                          handler: function handler() {
                            _this4.imageService.setGroupPhoto(_this4.group, _this4.camera.PictureSourceType.PHOTOLIBRARY);
                          }
                        }, {
                          text: 'Cancel',
                          icon: 'close',
          ...
          value: function newGroup() {
            ...
            var promise = new Promise(function (resolve, reject) {
              ...
              messages.push({
                ...
                type: 'system',
                message: 'This group has been created by "' + _this5.createName + '".',
                icon: 'chatbubbles'
              }); // Add members of the group

              var members = [];

              for (var i = 0; i < _this5.groupMembers.length; i++) {
                //let push the group member to member with only userId
                members.push(_this5.groupMembers[i].userId);
              } //Add group information and date


              _this5.group.dateCreated = new Date().toString(), _this5.group.messages = messages;
              _this5.group.members = members;

              if (_this5.group.img == '') {
                _this5.group.img = "assets/profile.png";
              }

              _this5.group.name = _this5.formGroup.value["name"];
              _this5.group.admin = [firebase__WEBPACK_IMPORTED_MODULE_5__["auth"]().currentUser.uid];
              _this5.group.createdBy = _this5.createName; // Lets add to firebase database

              _this5.angularDb.list('/groups/').push(_this5.group).then(function (success) {
                ...
                for (var _i = 0; _i < _this5.groupMembers.length; _i++) {
                  _this5.angularDb.object('/accounts/' + _this5.groupMembers[_i].userId + '/groups/' + groupId).update({
                    messagesRead: 1,
                    key: groupId
                  });

                  _this5.angularDb.database.ref('conversations').child(_this5.groupMembers[_i].userId).push(convasation).then(function () {
                    resolve(true);
                  }).then(function () {
                    _this5.showToast('Your groups has been created');
      ...
      NewgroupPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
        selector: 'app-newgroup',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./newgroup.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/newgroup/newgroup.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./newgroup.page.scss */
        "./src/app/pages/newgroup/newgroup.page.scss"))["default"]]
      })], NewgroupPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=pages-newgroup-newgroup-module-es5.js.map