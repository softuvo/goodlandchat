(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-calling-calling-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppPagesCallingCallingPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesCallingCallingRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesCallingCallingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      CallingPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], src_app_pipes_pipes_module__WEBPACK_IMPORTED_MODULE_7__["PipesModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _calling_routing_module__WEBPACK_IMPORTED_MODULE_5__["CallingPageRoutingModule"]],
    ...
    /***/
    function srcAppPagesCallingCallingPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesCallingCallingPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _ionic_native_native_audio_ngx__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      ...
      */
      ...
      var CallingPage = /*#__PURE__*/function () {
        function CallingPage(navCtrl, actRoute, nativeAudio, toastController, angularDb, loading) {
          ...
          this.nativeAudio.preloadSimple('calling', 'assets/audio/PhoneRinging.wav'); // this.InitializeApiRTC();
        ...
        _createClass(CallingPage, [{
          ...
          value: function InitializeApiRTC() {
            var _this2 = this;
            ...
            apiRTC.init({
              ...
              onReady: function onReady(e) {
                _this2.sessionReadyHandler(e);
              }
            });
          }
        }, {
          key: "sessionReadyHandler",
          value: function sessionReadyHandler(e) {
          ...
          key: "InitializeControlsForHangup",
          value: function InitializeControlsForHangup() {
            this.showCall = true;
          ...
          key: "RemoveMediaElements",
          value: function RemoveMediaElements(callId) {
            this.webRTCClient.removeElementFromDiv('mini', 'miniElt-' + callId);
            this.webRTCClient.removeElementFromDiv('remote', 'remoteElt-' + callId);
          }
        }, {
          key: "InitializeWebRTCClient",
          value: function InitializeWebRTCClient() {
          ...
          key: "InitializeControlsForIncomingCall",
          value: function InitializeControlsForIncomingCall() {
            this.showCall = false;
          ...
          value: function AddEventListeners() {
            ...
            apiRTC.addEventListener("userMediaSuccess", function (e) {
              ...
              _this3.showMyVideo = true;

              _this3.webRTCClient.addStreamInDiv(e.detail.stream, e.detail.callType, "mini", 'miniElt-' + e.detail.callId, {
                width: "128px",
                height: "96px"
              }, true);
            });
            apiRTC.addEventListener("userMediaError", function (e) {
              _this3.InitializeControlsForHangup();

              _this3.status = _this3.status + "<br/> The following error has occurred <br/> " + e;
            });
            apiRTC.addEventListener("incomingCall", function (e) {
              _this3.InitializeControlsForIncomingCall();

              _this3.incomingCallId = e.detail.callId;
            });
            apiRTC.addEventListener("hangup", function (e) {
              ...
              _this3.status = _this3.status + "<br/> The call has been hunged up due to the following reasons <br/> " + e.detail.reason;

              _this3.RemoveMediaElements(e.detail.callId);
            });
            apiRTC.addEventListener("remoteStreamAdded", function (e) {
              _this3.webRTCClient.addStreamInDiv(e.detail.stream, e.detail.callType, "remote", 'remoteElt-' + e.detail.callId, {
                width: "300px",
                height: "225px"
              }, false);
            });
            apiRTC.addEventListener("webRTCClientCreated", function (e) {
              ...
              _this3.webRTCClient.setAllowMultipleCalls(true);

              _this3.webRTCClient.setVideoBandwidth(300);

              _this3.webRTCClient.setUserAcceptOnIncomingCall(true);
              /*      this.InitializeControls();
                    this.AddEventListeners();*/
          ...
          value: function endCall() {
            ...
            this.angularDb.list('/accounts/' + firebase__WEBPACK_IMPORTED_MODULE_7__["auth"]().currentUser.uid + '/call/').push({
              ...
              _this4.angularDb.list('/accounts/' + _this4.userId + '/call/').push({
                date: new Date().toString(),
                ...
                _this4.nativeAudio.stop('calling');
      ...
      CallingPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_5__["Component"])({
        selector: 'app-calling',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./calling.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/calling/calling.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./calling.page.scss */
        "./src/app/pages/calling/calling.page.scss"))["default"]]
      })], CallingPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=pages-calling-calling-module-es5.js.map